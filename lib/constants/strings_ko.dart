class StringsKo {
  ...
  static const addNewSite = '새 현장 추가';
  static const siteNameLabel = '현장 이름';
  static const siteNameRequired = '현장 이름을 입력해주세요.';
  static const siteDateLabel = '점검 날짜';
  static const selectDate = '날짜 선택';
  static const next = '다음';
  static const cancel = '취소';
  static const create = '생성';
  static const importPdfTitle = 'PDF 도면 가져오기';
  static const importPdfSubtitle = '도면 있음 (PDF 파일)';
  static const createBlankTitle = '도면 없음';
  static const createBlankSubtitle = '빈 캔버스로 시작';
  static const selectDrawingTitle = '도면 유무 선택';
  ...
  static const defectDetailsTitleCrack = '균열 결함 상세';
  static const defectDetailsTitleLeakage = '누수 결함 상세';
  static const defectDetailsTitleConcrete = '콘크리트 결함 상세';
