...
extension _DrawingScreenUi on _DrawingScreenState {
              ...
              Row(
                children: [
                  ...
                  IconButton(
                    ...
                    tooltip: '?ÑÏû¨ ?òÏù¥ÏßÄ ?ïÍ¥ë?úÎßå ÏßÄ?∞Í∏∞',
                  ),
                  IconButton(
                    ...
                    tooltip: '?ÑÏû¨ ?òÏù¥ÏßÄ ?úÎßå ÏßÄ?∞Í∏∞',
                  ),
                  IconButton(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      const Expanded(child: Text('?ÑÌòï ?§Ï†ï')),
                      SizedBox(
                        width: 32,
                        height: 32,
                        child: IconButton(
                  ...
                  Row(
                    children: [
                      const SizedBox(width: 72, child: Text('?åÎëêÎ¶???)),
                      Expanded(
                        child: Wrap(
                          spacing: 6,
                          runSpacing: 6,
  ...
  String _labelForShapeType(ShapeType type) {
    return switch (type) {
      ShapeType.rectangle => '?¨Í∞Å??,
      ShapeType.circle => '?êÌòï',
      ShapeType.triangle => '?ºÍ∞Å??,
      ShapeType.hShape => 'H Î™®Ìòï',
    };
  }
