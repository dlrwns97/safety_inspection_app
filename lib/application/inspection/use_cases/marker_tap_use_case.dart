...
class MarkerTapUseCase {
  MarkerTapUseCase({
    CreateDefectMarkerUseCase? createDefectMarkerUseCase,
    CreateEquipmentUpdatedSiteUseCase? createEquipmentUpdatedSiteUseCase,
  }) : _createDefectMarkerUseCase =
           createDefectMarkerUseCase ?? CreateDefectMarkerUseCase(),
       _createEquipmentUpdatedSiteUseCase =
...
class _EquipmentMarkerDraft {
  const _EquipmentMarkerDraft({required this.prefix, required this.marker});
